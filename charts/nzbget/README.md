...
```console
helm install --name my-release xmple/nzbget
```
...
Read through the [values.yaml](https://github.com/xmple/charts/blob/master/nzbget/values.yaml) file. It has several commented out suggested values.